function zees = build_id_data(idRun, checkRun)
...
for i = 1:length(dataType)
    runData.(dataType{i}) = load([PATH_TO_RUN_MAT_DIRECTORY idRun], 'RollRate', 'SteerRate', 'RollAngle', ...
